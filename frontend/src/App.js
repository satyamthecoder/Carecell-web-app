...
// this is for public health card
...
//         {/* Protected *//*}
 /*         <Route path="/" element={<PrivateRoute><Layout /></PrivateRoute>}>
         ...
         // below line for public health card  
           <Route path="/public-healthcard/:userId" element={<PublicHealthCard />} />
           // below line for paitent profile 
    ...
    <Router>
      <Toaster
        ...
        toastOptions={{
          ...
          error: {
            iconTheme: { primary: '#c80d0d', secondary: 'white' }
          },
        }}
      />
      ...
      <Suspense fallback={<LoadingSpinner fullScreen />}>
        <Routes>
          ...
          {/* ✅ PUBLIC QR HEALTH CARD (NO LOGIN REQUIRED) */}
          <Route path="/public-healthcard/:userId" element={<PublicHealthCard />} />
