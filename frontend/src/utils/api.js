...
// AI
export const aiAPI = {
  explainTerm: (term, language) =>
    api.post('/ai/explain-term', { term, language }),
  explainConsent: (text) =>
    api.post('/ai/explain-consent', { text }),
  buddyAssessment: (checkinData) =>
    api.post('/ai/buddy-assessment', { checkinData }),
};

// Emergency
export const emergencyAPI = {
  getNearest: (lat, lng, city) =>
    api.get('/emergency/nearest', { params: { lat, lng, city } }),
  getHelplines: () => api.get('/emergency/helplines'),
};
